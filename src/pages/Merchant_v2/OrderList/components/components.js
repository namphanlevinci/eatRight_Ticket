...
import CloseXIcon from '../assets/closeIcon';
import logo from '../assets/logo/logo.png';
import { Text } from 'components/atom/Text';
export const Header = ({ onClose, onLogo }) => {
    return (
...
export const RenderItem = ({ icon, title, onPress, color }) => {
    return (
        <Row
...
export const RenderLogout = ({ onPress }) => {
    return (
        <Row
            justify={'center'}
            align={'middle'}
