...
import ModalInputQuantity from 'components/modal/ModalInputQuantity';
        ...
        <>
            ...
            <Row align={'middle'}>
                <div
                    ...
                    onClick={() =>
                        !isSend &&
                        setQuantity(Math.max(quantity - 1, 0), 'decrea')
                    }
                >
                    <svg
                        width="40"
                ...
                >
                    <Text
                        style={{ color: theme.tEXTDisabled, fontWeight: 600 }}
                    >
                        {quantity}
                    </Text>
                </div>
