export const BASE_ROUTER = {
    ...
    RECEIPTS: '/receipts',
    MERCHANT_BATCH_HISTORY: '/batch-history',
    MERCHANT_SETTLE: '/settle',
    MERCHANT_TRANSACTIONS: '/transactions',
    MERCHANT_SALES_REPORT: '/report',
    MERCHANT_REPORT_BY_PAYMENT: '/report/:method',
    MERCHANT_ORDERLIST: '/merchant-order-list',
    MERCHANT_TABLEVIEW: '/merchant-table-view',
};
